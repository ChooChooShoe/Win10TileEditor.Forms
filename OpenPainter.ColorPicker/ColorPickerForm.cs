...
namespace OpenPainter.ColorPicker
{
    ...
    public partial class ColorPickerForm : Form
    {
        ...
        public ColorPickerForm(Color startingColor)
		{
            ...
            rgb = startingColor;
			hsl = AdobeColors.ToHSB(rgb);
			cmyk = AdobeColors.ToCMYK(rgb);
        ...
        private void chkWebColorsOnly_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                rgb = AdobeColors.GetNearestWebSafeColor(rgb);
                hsl = AdobeColors.ToHSB(rgb);
                cmyk = AdobeColors.ToCMYK(rgb);
    ...
    public enum ColorComponent { Hue, Saturation, Brightness, Red, Green, Blue }
